        ...
        <div key={index} className='rounded-[20px] w-[220px] sm:w-[250px] h-[300px] sm:h-[350px] border-gray-100 transition-all duration-300'>
          <div className='flex justify-center bg-[#e7ecef] rounded-[30px] overflow-hidden'>
            <img 
              src={item.image} 
              alt="" 
              className='w-[260px] sm:w-[280px] h-[200px] sm:h-[280px] px-6 pt-6 z-3 hover:scale-110 transition-transform duration-700 object-contain' 
            />
          </div>
          ...
          <div className='h-[110px] flex flex-col justify-center items-center pb-5'>
            ...
            <p className='text-[13px] sm:text-[15px] text-gray-600'>{item.speciality}</p>
          </div>
        </div>
      ))}
    </div>
