    ...
    return (
        ...
        >
            <div className="text-center max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl">
                <p className="text-white text-base md:text-lg mb-2 md:mb-4 animate_animated animate_fadeInUp">
                    Visite Clinick
                </p>

                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2 md:mb-4 animate_animated animate_fadeInUp">
                    Notre Cabinet Dentaire
                </h1>

                <p className="text-white text-sm md:text-base lg:text-lg mb-4 md:mb-8 animate_animated animate_fadeInUp">
