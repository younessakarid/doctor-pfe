...
function LocationComponent() {
  return (
    <div className='flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 px-4 md:px-0 pt-8 md:pt-15 pl-4 md:pl-9 mb-20 lg:mt-7'>
      
      {/* Map iframe */}
      <iframe
        className='rounded-[30px] filter brightness-90 transition-all duration-300 hover:brightness-110 w-full md:max-w-[550px] h-64 md:h-[500px] order-2 md:order-1'
      ...
      {/* Contact Info */}
      <div className='flex flex-col gap-6 md:gap-10 w-full md:max-w-[550px] order-1 md:order-2'>
        <div>
          <div className='flex items-center gap-2 pb-2'>
            <WiStars className='text-lg md:text-xl text-[#1e84b5]' />
            <p className='text-base md:text-xl text-[#1e84b5]'>CONTACT NOW</p>
          </div>
          <h1 className='text-2xl md:text-4xl text-[#0e384c] font-bold'>
        ...
        <div className='flex items-center gap-3'>
          <SlLocationPin className='text-xl md:text-2xl text-[#1e84b5]' />
          <p className='text-blue-950 text-sm md:text-base'>59 Avenue de la Bourdonnais 75007 – PARIS</p>
        </div>

        <div className='flex items-center gap-3'>
          <BsTelephoneForward className='text-xl md:text-2xl text-[#1e84b5]' />
          <p className='text-blue-950 text-sm md:text-base'>+33 (0)1 45 63 20 00</p>
        </div>

        <div className='flex items-center gap-3'>
          <MdOutlineMarkEmailUnread className='text-xl md:text-2xl text-[#1e84b5]' />
          <p className='text-blue-950 text-sm md:text-base'>contact@dental7paris.com</p>
        </div>

        <div className='flex items-center gap-3'>
          <RxTimer className='text-xl md:text-2xl text-[#1e84b5]' />
