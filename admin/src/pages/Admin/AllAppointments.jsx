...
import { MdCancel, MdCalendarMonth, MdPerson, MdLocalHospital } from 'react-icons/md'
      ...
      <div className="flex-grow p-6 max-w-full">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            {/* Table Header */}
            <div className="hidden lg:grid grid-cols-[0.5fr_2fr_1fr_2fr_2fr_1fr_1.5fr] gap-4 px-6 py-4 bg-gray-50 border-b border-gray-200">
              ...
              {appointments.length === 0 ? (
                ...
                appointments.map((item, index) => (
                  <div key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                    ...
                    {/* Desktop Row */}
                    <div className="hidden lg:grid grid-cols-[0.5fr_2fr_1fr_2fr_2fr_1fr_1.5fr] gap-4 px-6 py-4 items-center">
                      ...
                      <div className="text-sm text-gray-600 font-medium">{calculateAge(item.userData.dob)} ans</div>

                      <div className="text-sm text-gray-700">
                        <span className="font-medium">{slotDateFormat(item.slotDate)}</span><br />
                      ...
                      <div className="text-sm font-bold text-green-600">{currency}{item.amount}</div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {!item.cancelled && !item.isCompleted && (
                          <button
                            ...
                            className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition duration-200 hover:scale-110"
                    ...
                    <div className="lg:hidden p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gray-50 p-3 rounded-lg">
                          ...
                          <p className="text-sm font-semibold text-blue-600">{item.slotTime}</p>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <p className="text-xs text-gray-500 mb-1">Frais</p>
                          <p className="text-sm font-bold text-green-600">{currency}{item.amount}</p>
                        </div>
                      </div>
