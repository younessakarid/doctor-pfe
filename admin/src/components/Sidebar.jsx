...
const Sidebar = () => {
  ...
  return (
    <div className='min-h-screen bg-[#eff8ff] border-r border-gray-400'>
      ...
      {dToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/doctor-dashboard'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer hover:text-[#1e84b5] ${isActive ? 'bg-[#F2F3FF] text-[#1e84b5] border-r-4 border-[#1e84b5]' : ''}`}>
          <img className='min-w-5' src={home_icon} alt='' />
          <p className='hidden md:block'>Dashboard</p>
        </NavLink>
        <NavLink to={'/doctor-appointments'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer hover:text-[#1e84b5] ${isActive ? 'bg-[#F2F3FF]  text-[#1e84b5] border-r-4 border-[#1e84b5]' : ''}`}>
          <img className='min-w-5' src={appointment_icon} alt='' />
          <p className='hidden md:block'>Appointments</p>
        </NavLink>
        
        <NavLink to={'/doctor-profile'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer hover:text-[#1e84b5] ${isActive ? 'bg-[#F2F3FF] text-[#1e84b5] border-r-4 border-[#1e84b5]' : ''}`}>
          <img className='min-w-5' src={people_icon} alt='' />
